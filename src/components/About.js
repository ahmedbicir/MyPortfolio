      ...
      <div className="head">
         ...
         <div className="bio" id="about">
            ...
            <div className="bio_sawir">
               <h1>why choose me?</h1>
             <p> I am a Web Designer, Web Developer with over 2years of experience. Experienced with all stages of the development cycle for dynamic and static web projects.developing and designing user interfaces,testing, debugging and  training staff. proven ability in optimizing  web functionalities that improve data retrieval and workflow efficiencies.
               </p>
